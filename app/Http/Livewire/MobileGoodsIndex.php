...
class MobileGoodsIndex extends Component
{
    ...
    public function showEditgoodsModal($id){
        $goods = m_user::findOrFail($id);
        $this->Id = $goods->id;
        $this->authority = $goods->authority;
        $this->user_name = $goods->user_name;
        $this->affiliation = $goods->affiliation;
        $this->operation = $goods->operation;
        $this->loginid = $goods->loginid;
        $this->password = $goods->password;
        $this->email = $goods->email;
        $this->editWork = true;
        $this->liveModal = true;
    }
    ...
    public function render()
    {
        ...
        if( $this->search!="" ){
            return view('livewire.mobilegoods-index',compact('authoritys'), [
    ...
    public function mobilegoods_select($id){
        $goods = m_user::findOrFail($id);
        $goods->delete();
        $this->reset();
    }
